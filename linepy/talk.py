        ...
        if db['unsendMessage'] == True:
            ...
            if op.param2 in database["message"][op.param1]:
                ...
                if msg.contentType == 0:
                    if msg.text != None:
                        a = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/jrrMPdG/1553179449707.jpg","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : Text","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : {}".format(str(msg.text)),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/6281445291130"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~Adamcherif1993"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/__TRSC_OLALA__"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
                        b = self.sendCarousel(msg.to, a)
                if msg.contentType == 1:
                    if "MEDIA_CONTENT_INFO" in msg.contentMetadata.keys() != None:
                        a = {"messages": [{"type": "flex", "altText": "Resend Message", "contents": {"styles":{"body":{"backgroundColor":"#000000"},"footer":{"backgroundColor":"#800000"}},"type":"bubble","body":{"contents":[{"contents":[{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Resend Message","size":"xs","align":"center","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"url":"https://obs.line-scdn.net/{}".format(self.getContact(msg._from).pictureStatus),"type":"image"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"type":"image","url":"https://i.ibb.co/jrrMPdG/1553179449707.jpg","size":"xl"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"contents":[{"text":"Kenapa di unsend bro?","size":"xs","align":"center","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Sender : {}".format(self.getContact(msg._from).displayName),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Time : {}".format(humanize.naturaltime(datetime.fromtimestamp(msg.createdTime/1000))),"size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"text":"- Type : Image/GIF","size":"xs","color":"#FFFFFF","wrap":True,"weight":"bold","type":"text"}],"type":"box","layout":"baseline"},{"type":"separator","color":"#000000"},{"contents":[{"type":"separator","color":"#000000"},{"text":"Pesan : Check the GIF Below","size":"xs","color":"#000000","wrap":True,"weight":"bold","type":"text"}],"type":"box","spacing":"md","layout":"horizontal"},{"type":"separator","color":"#000000"},{"type":"separator","color":"#000000"},{"contents":[{"type":"image","url":"https://i.ibb.co/4N1BjnV/20190427-175005.png","size":"xl","action":{"type":"uri","uri":"https://wa.me/6281445291130"},"flex":1},{"type":"image","url":"https://i.ibb.co/b53ztTR/20190427-191019.png","size":"xl","action":{"type":"uri","uri":"http://line.me/ti/p/~Adamcherif1993"},"flex":1},{"type":"image","url":"https://i.ibb.co/ZHtFDts/20190427-185307.png","size":"xl","action":{"type":"uri","uri":"line://nv/chat"},"flex":1},{"type":"image","url":"https://i.ibb.co/8YfQVtr/20190427-185626.png","size":"xl","action":{"type":"uri","uri":"line://call/contacts"},"flex":1},{"type":"image","url":"https://i.ibb.co/hVWDsp8/20190428-232907.png","size":"xl","action":{"type":"uri","uri":"Https://smule.com/__TRSC_OLALA__"},"flex":1}],"type":"box","layout":"horizontal"},{"type":"separator","color":"#000000"}],"type":"box","layout":"vertical"}],"type":"box","spacing":"xs","layout":"vertical"}}}]}
